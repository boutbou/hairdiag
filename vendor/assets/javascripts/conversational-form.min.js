        ...
        return Object.defineProperty(e.prototype, "active", {
            ...
            if (i && i.length > 0) {
                ...
                var c = this.el.offsetWidth,
                    h = this.listWidth > c;
                h && !r ? (this.el.classList.add("two-row"), this.listWidth = Math.max(c, Math.round(o[Math.floor(o.length / 2)] + 50)), this.list.style.width = this.listWidth + "px") : this.el.classList.add("one-row");
                for (var a = 0; a < i.length; a++) {
                    var l = i[a];
                    l.visible && l.calcPosition()
                }
                c = this.el.offsetWidth, h = this.listWidth > c;
                for (var u = i.slice(), p = u.sort(function(t, e) {
    ...
    var e = function() {
        function e(t) {
            this.data = {
                ...
                "robot-image": "http://www.progressillinois.com/sites/progressillinois.com/files/styles/content_scale/public/pi-images/bernie_sanders_hair_logo.png?itok=5TMSNxU1",
...
! function(cf) {
    ...
    var Tag = function() {
        ...
        return Object.defineProperty(Tag.prototype, "type", {
            ...
            if ("string" == typeof t) {
                for (var n = t, i = !1, o = 0; o < e.conditionals.length; o++) {
                    var s = e.conditionals[o];
                    if (i = "object" == typeof s ? s.test(n) : t === s) break
                }
                return i
            }
            if (t) {
                for (var i = !1, o = 0; o < e.conditionals.length; o++) {
                    var s = e.conditionals[o];
                    if (i = t.toString() == s.toString()) break
                }
                return i
            }
            return !1
            ...
            for (var e = 0; e < this.conditionalTags.length; e++) {
                if ("cf-conditional-" + t === this.conditionalTags[e].key) return !0
            }
            return !1
                ...
                for (var e in t)
                    if (t.hasOwnProperty(e)) {
                        ...
                        if (n && n.name && -1 !== n.name.indexOf("cf-conditional")) {
                            for (var i = [], o = n.value.split("||"), s = 0; s < o.length; s++) {
                                var r = o[s];
                                try {
                                    i.push(new RegExp(r))
                                } catch (t) {}
...
! function(t) {
    var e = function() {
        function e(e) {
            this.elements = e.elements, this._fieldset = e.fieldset, this._fieldset && this._fieldset.getAttribute("cf-questions") && (this.questions = t.Helpers.getValuesOfBars(this._fieldset.getAttribute("cf-questions"))), t.ConversationalForm.illustrateAppFlow && console.log("Conversational Form > TagGroup registered:", this.elements[0].type, this)
        }
            ...
            this._files = this.referenceTag.domElement.files, i.onerror = function(t) {
                ...
                if (s > n.maxFileSize) {
                    ...
                    var c = 1 * Number((s / Math.pow(1024, a)).toFixed(2)) + " " + l[a],
                        h = o.name + " (" + c + ")";
                    n.el.getElementsByTagName("cf-upload-file-text")[0].innerHTML = h, n.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementEvents.PROGRESS_CHANGE, {
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "hasUserMedia", {
            ...
            void 0 === e && (e = 0), this.button.loading = !0, this.equalizer && (this.equalizer.disabled = !1), this.promise = new Promise(function(t, e) {
                ...
                })), console.log("Conversational Form: Terminal error: ", e)) : (n.inputCurrentError != e && (n.inputErrorCount = 0, n.inputCurrentError = e), n.inputErrorCount++, n.inputErrorCount > 2 ? n.showError(e) : (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {
                    detail: t.Dictionary.get("microphone-terminal-error")
...
! function(t) {
    ...
    e.ERROR_TIME = 2e3, e.preventAutoFocus = !1, e.hideUserInputOnNoneTextInput = !1, t.UserInputElement = e, t.UserInputEvents = {
    ...
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "active", {
            ...
            set: function(t) {
                ...
                console.log("option hasChanged", t), e && (this._disabled = t, t ? (this.el.setAttribute("disabled", "disabled"), this.inputElement.blur()) : (this.setFocusOnInput(), this.el.removeAttribute("disabled")))
            },
            enumerable: !0,
            configurable: !0
            ...
            this.inputElement.setAttribute("data-value", this.inputElement.value), this.inputElement.value = "", this.el.setAttribute("error", ""), this.disabled = !0, this.inputElement.setAttribute("placeholder", i.errorText || this._currentTag.errorMessage), clearTimeout(this.errorTimer), this.submitButton.loading = !1, this.errorTimer = setTimeout(function() {
                n.disabled = !1, console.log("option, disabled 1"), n.el.removeAttribute("error"), n.inputElement.value = n.inputElement.getAttribute("data-value"), n.inputElement.setAttribute("data-value", ""), n.setPlaceholder(), n.setFocusOnInput(), n.submitButton.reset(), n.controlElements && n.controlElements.resetAfterErrorMessage()
            ...
            var n = e.detail;
            this.disabled = n == t.ControlElementProgressStates.BUSY, console.log("option, disabled 2")
...
! function(t) {
    ...
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "tag", {
            ...
            this.image = t, this.el.getElementsByTagName("thumb")[0].style.backgroundImage = 'url("' + this.image + '")'
        }, n.prototype.setLinkToOtherReponse = function(t) {
            this.responseLink = t
        }, n.prototype.processResponseAndSetText = function() {
            var e = this;
            if (this.originalResponse) {
                var i = this.originalResponse;
                if (this._tag && "password" == this._tag.type && !this.isRobotResponse) {
                    for (var o = "", s = 0; s < i.length; s++) o += "*";
                    i = o
                } else i = t.Helpers.emojify(i);
                if (this.responseLink && this.isRobotResponse && (i = i.split("{previous-answer}").join(this.responseLink.parsedResponse)), this.isRobotResponse)
                    for (var r = n.list.getResponses(), a = 0; a < r.length; a++) {
                        var l = r[a];
                        l !== this && l.tag && (l.tag.id && (i = i.split("{" + l.tag.id + "}").join(l.tag.value)), l.tag.name && (i = i.split("{" + l.tag.name + "}").join(l.tag.value)))
                    }
                if (-1 != i.indexOf("contains-image") && this.textEl.classList.add("contains-image"), this.isRobotResponse) {
                    this.textEl.innerHTML = "";
                    var c = this.uiOptions.robot.robotResponseTime;
                    0 != c && this.setToThinking();
                    for (var h = i.split("&&"), u = this, p = 0; p < h.length; p++) ! function(t) {
                        var n = h[t];
                        setTimeout(function() {
                            e.tryClearThinking(), e.textEl.innerHTML += "<p>" + n + "</p>";
                            var t = e.textEl.getElementsByTagName("p");
                            t[t.length - 1].offsetWidth, t[t.length - 1].classList.add("show"), e.scrollTo()
                        }, c + (t + 1) * u.uiOptions.robot.chainedResponseTime)
                    }(p);
                    this.readyTimer = setTimeout(function() {
                        e.onReadyCallback && e.onReadyCallback(), e.onReadyCallback = null
                    }, c + h.length * this.uiOptions.robot.chainedResponseTime)
                } else {
                    this.tryClearThinking(), this.textEl.innerHTML = "<p>" + i + "</p>";
                    var d = this.textEl.getElementsByTagName("p");
                    d[d.length - 1].offsetWidth, d[d.length - 1].classList.add("show"), this.scrollTo()
                }
                this.parsedResponse = i, this.addSelf(), this.textEl.removeAttribute("value-added"), setTimeout(function() {
                    e.textEl.setAttribute("value-added", ""), e.el.classList.add("peak-thumb")
                }, 0), this.checkForEditMode(), this.response = i.split("&&").join(" ")
            }
    ...
    e.THINKING_MARKUP = "<p class='show'><thinking><span>.</span><span>.</span><span>.</span></thinking></p>", t.ChatResponse = e
}(cf || (cf = {}));
var __extends = this && this.__extends || function() {
        var t = Object.setPrototypeOf || {
            __proto__: []
            ...
            for (var i = 0, o = 0; o < this.tags.length; o++) {
                ...
                if (s !== e)
                    for (var r = 0; r < n.length; r++) {
                        var a = n[r];
                        if ("cf-conditional-" + s.name === a.key) {
                            var l = (s.value, s.value),
                                c = t.Tag.testConditions(l, a);
                            if (c && (this.activeConditions[s.id || s.name] = n, ++i == n.length)) return !0
                        }
                    }
            }
            return !1
...
! function(cf_1) {
    var ConversationalForm = function() {
        ...
        return Object.defineProperty(ConversationalForm.prototype, "createId", {
            ...
            if (cf_1.Helpers.setEmojiLib(), this.loadExternalStyleSheet) {
            ...
            this.userInput.disabled = !1, console.log("option, disabled 3"), this.userInput.visible = !0, this.flowManager.start()
